...
import hostlinkerror
import hostlinkconst as const
...
class HostLink:
    ...
    def set_time(self, year, month, day, hour, minutes, seconds, weeks):
        ...
        Args:
            ...
            weeks: Enter the week using 1 digit. The table below shows the relationship between day of the
        """
        subheader = "WRT"
